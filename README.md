...
<br>
- Você não pode exportar uma VM se ela contiver software de terceiros fornecido pela AWS. Por exemplo, o VM Export  <u> <b> não pode exportar instâncias do Windows ou SQL Server </b> </u>, ou qualquer instância criada a partir de uma imagem no AWS Marketplace. <br>
